...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/weilei/Projects/3d_detection/boolmap_multihead_128m1114_18a/boolmap_multihead_128m1114_18a.yaml", help='specify the config for training')
    parser.add_argument('--filename_mh', type=str, default="/home/weilei/Projects/3d_detection/boolmap_multihead_128m1114_18a/ckpt/checkpoint_epoch_100.pth", help='specify the config for training')
    parser.add_argument('--export_onnx_file', type=str, default="tst.onnx", help='specify the config for training')
