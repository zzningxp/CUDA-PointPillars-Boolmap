...
from pcdet.thirdparty.nuscenes.eval.detection.data_classes import DetectionMetricData
from pcdet.thirdparty.nuscenes.eval.common.utils import center_distance, scale_iou, yaw_diff, velocity_l2, attr_acc, cummean
...
def accumulate(gt_boxes: EvalBoxes,
    ...
    print(class_name, 'TP num: %d TP/GtNum: %.2f FP num: %d FP/GtNum: %.2f' % (np.sum(tp), np.sum(tp)/npos, np.sum(fp), np.sum(fp)/npos))
    # ---------------------------------------------
