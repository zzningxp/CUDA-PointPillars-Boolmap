...
from pcdet.thirdparty.nuscenes.eval.common.data_classes import EvalBoxes
from pcdet.thirdparty.nuscenes.eval.detection.utils import category_to_detection_name
from pcdet.thirdparty.nuscenes.eval.detection.data_classes import DetectionBox
from pcdet.thirdparty.nuscenes.eval.tracking.utils import category_to_tracking_name
from pcdet.thirdparty.nuscenes.eval.tracking.data_classes import TrackingBox
from pcdet.thirdparty.nuscenes.utils.data_classes import Box
from pcdet.thirdparty.nuscenes.utils.geometry_utils import points_in_box
from pcdet.thirdparty.nuscenes.utils.splits import create_splits_scenes
...
def filter_eval_boxes(nusc: NuScenes,
    ...
    for first_key in list(eval_boxes.boxes.keys()):
        if len(eval_boxes.boxes[first_key]) > 0:
